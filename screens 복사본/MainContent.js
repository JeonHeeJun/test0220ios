...
import { StyleSheet, Text, View, Button,ScrollView,TouchableOpacity, Image, Dimensions,
...
const CustomMenu = (props) => { //메뉴 버튼
  ...
  return (
    <View style={props.menustyle}>
              ...
              >
        <TouchableOpacity style={styles.card} onPress={()=>{tnum =20 ; 
 ...
 // console.log("GetAllPost진입@@@@@@@@@@@@@@",init)
  ...
  return(  
    ...
    refreshControl={<RefreshControl refreshing={refreshing} onRefresh ={onRefresh}/>}
      ...
      <View style={{borderWidth:1,position:'absolute',bottom:'4%',alignSelf:'center'}}>
      {type == 0 ?
...
const UpdateScreen = ({navigation, upload})=>{
  ...
  return(<KeyboardAwareScrollView>
      ...
      <View style={{flex:1 ,marginTop:'15%', marginHorizontal:10 ,flexDirection:'row',justifyContent:'space-between'}}>
    <View style = {{flexDirection: 'row'}}>
